  ...
  const services = [
    {
      ...
      title: "HVAC Systems",
      description:
        "Complete installation, maintenance, and repair of heating, ventilation, and air conditioning systems for residential and commercial properties.",
      features: [
        "Installation",
        "Maintenance",
        "Emergency Repairs",
    ...
    },
    {
      ...
      title: "Refrigeration",
      description:
        "Professional refrigeration services for commercial kitchens, cold storage, and industrial refrigeration systems.",
      features: [
    ...
    },
    {
      ...
      description:
        "Specialized medical gas pipeline systems for healthcare facilities, ensuring safety and regulatory compliance.",
      features: [
    ...
    },
    {
      ...
      description:
        "Comprehensive maintenance plans to ensure optimal performance and extend the life of your systems.",
      features: [
        "Annual Plans",
        "Regular Inspections",
  ...
  const testimonials = [
    {
      ...
      content:
        "A/C Clinic installed our medical gas pipeline system flawlessly. Their attention to safety regulations and professional service exceeded our expectations.",
      rating: 5,
    },
    {
      name: "Michael Chen",
      ...
      content:
        "Their commercial refrigeration maintenance has saved us thousands in potential downtime. Highly professional and always available when we need them.",
      rating: 5,
    },
    {
      ...
      role: "Homeowner",
      content:
        "The annual maintenance plan is excellent value. Our HVAC system runs perfectly, and their emergency service is outstanding.",
      rating: 5,
    },
  ];
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-xl text-gray-600 leading-relaxed">
                  Expert installation, maintenance, and emergency repair
                  services for residential, commercial, and healthcare
                  facilities. Available 24/7 with guaranteed quality and
                  compliance.
                </p>
              </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We are Rwanda's leading HVAC and medical gas pipeline specialists,
              committed to excellence, safety, and customer satisfaction in
            ...
            <div className="space-y-6">
              <div className="space-y-4">
                ...
                <p className="text-gray-600 leading-relaxed">
                  To provide exceptional HVAC, refrigeration, and medical gas
                  pipeline solutions that ensure comfort, safety, and regulatory
                  compliance for our clients across Rwanda.
                </p>
              </div>
                ...
                <ul className="space-y-3">
                  <li className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <div className="text-gray-600">
                        Adherence to all safety regulations and best practices
                      </div>
                    </div>
                  </li>
                  <li className="flex items-start space-x-3">
                  ...
                  <li className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <div className="text-gray-600">
                        24/7 support and responsive service delivery
                      </div>
                    </div>
                  </li>
                </ul>
      ...
      <section id="services" className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Comprehensive HVAC, refrigeration, and medical gas pipeline
              services for residential, commercial, and healthcare facilities.
            </p>
          </div>
      ...
      <section id="pricing" className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Clear, upfront pricing with no hidden fees. Choose the plan that
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600">
                Schedule your HVAC, refrigeration, or medical gas pipeline
                service today.
              </p>
            </div>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      ...
                      <SelectContent>
                        <SelectItem value="hvac-installation">
                          HVAC Installation
                        </SelectItem>
                        ...
                        <SelectItem value="refrigeration">
                          Refrigeration Service
                        </SelectItem>
                        <SelectItem value="medical-gas">
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Meet the experienced professionals leading A/C Clinic to
              excellence in HVAC and medical gas solutions.
            </p>
          </div>
      ...
      <section id="contact" className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Ready to experience professional HVAC service? Contact us today
              for consultation, emergency service, or to schedule your
              maintenance.
            </p>
          </div>
