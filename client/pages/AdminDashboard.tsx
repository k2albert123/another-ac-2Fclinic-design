...
export default function AdminDashboard() {
  ...
  const serviceTypes = [
    { name: "HVAC Systems", count: 567, icon: <Snowflake className="h-5 w-5" />, color: "bg-blue-500" },
    { name: "Refrigeration", count: 423, icon: <Building className="h-5 w-5" />, color: "bg-green-500" },
    { name: "Medical Gas", count: 234, icon: <Heart className="h-5 w-5" />, color: "bg-red-500" },
    { name: "Maintenance", count: 232, icon: <Wrench className="h-5 w-5" />, color: "bg-yellow-500" }
  ];
          ...
          <div className="mb-8">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
              <div>
                ...
                <p className="text-gray-600 mt-1">Welcome back! Here's what's happening at A/C Clinic today.</p>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">
                  <span className="text-blue-600">{stats.todayBookings}</span> scheduled today
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">
                  <span className="text-yellow-600">{stats.pendingBookings}</span> pending assignments
                </p>
              </CardContent>
            </Card>
          </div>
                  ...
                  <div className="space-y-4">
                    {serviceTypes.map((service) => (
                      <div key={service.name} className="flex items-center justify-between">
                        ...
                        <div className="text-right">
                          <Progress value={(service.count / 1456) * 100} className="w-20 mb-1" />
                          <p className="text-xs text-gray-500">
                  ...
                  <div className="space-y-4">
                    {notifications.map((notification) => (
                      <div key={notification.id} className="flex items-start space-x-3">
                        <div className={`p-1 rounded-full ${notification.urgent ? 'bg-red-100' : 'bg-blue-100'}`}>
                          {notification.type === "booking" && <Calendar className="h-3 w-3 text-blue-600" />}
                          {notification.type === "payment" && <DollarSign className="h-3 w-3 text-green-600" />}
                          {notification.type === "technician" && <Wrench className="h-3 w-3 text-purple-600" />}
                          {notification.type === "system" && <Settings className="h-3 w-3 text-gray-600" />}
                        </div>
                        <div className="flex-1">
